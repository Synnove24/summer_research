...
int crtana_all_histograms() {
	...
	//Save as pngs
	//Time
        c_t_t->SaveAs("t1_test.png");

	//No time cut
        c1_f->SaveAs("Front_face_x_no_time_cut_test.png");
        c2_f->SaveAs("Front_face_y_no_time_cut_test.png");
        c3_f->SaveAs("Front_face_no_time_cut_test.png");
        c1_b->SaveAs("Back_face_x_no_time_cut_test.png");
        c2_b->SaveAs("Back_face_y_no_time_cut_test.png");
        c3_b->SaveAs("Back_face_no_time_cut_test.png");
        c1_l->SaveAs("Left_face_y_no_time_cut_test.png");
        c2_l->SaveAs("Left_face_z_no_time_cut_test.png");
        c3_l->SaveAs("Left_face_no_time_cut_test.png");
        c1_r->SaveAs("Right_face_y_no_time_cut_test.png");
        c2_r->SaveAs("Right_face_z_no_time_cut_test.png");
        c3_r->SaveAs("Right_face_no_time_cut_test.png");
        c1_t->SaveAs("Top_face_x_no_time_cut_test.png");
        c2_t->SaveAs("Top_face_z_no_time_cut_test.png");
        c3_t->SaveAs("Top_face_no_time_cut_test.png");
        c1_d->SaveAs("Bottom_face_x_no_time_cut_test.png");
        c2_d->SaveAs("Bottom_face_z_no_time_cut_test.png");
        c3_d->SaveAs("Bottom_face_no_time_cut_test.png");	
	...
	//Time cut
        ...
        //Time cut gaussian
        c1_f_t_g->SaveAs("Front_face_x_time_cut_gaussian_test.png");
        c2_f_t_g->SaveAs("Front_face_y_time_cut_gaussian_test.png");
        c3_f_t_g->SaveAs("Front_face_time_cut_gaussian_test.png");	
	...
	//No cosmic rays gaussian
        c1_f_nocr_g->SaveAs("Front_face_x_nocr_gaussian_test.png");
        c2_f_nocr_g->SaveAs("Front_face_y_nocr_gaussian_test.png");
        c3_f_nocr_g->SaveAs("Front_face_nocr_gaussian_test.png");
